...
<template>
  <div class="container mx-auto mt-[153px] mb-[100px]">
    ...
    <div class="flex flex-col lg:flex-row max-w-[1228px] mx-auto gap-[50px]">
      <div class="lg:order-2 flex flex-col py-[29px]">
        <div class="lg:order-3 flex gap-[24px] justify-center lg:justify-start mb-[50px] lg:mb-0">
        ...
        <div class="hidden lg:block lg:order-2 my-[50px]">
          <div id="map" class="w-[516px] h-[323px] mx-auto"></div>
        </div>
        <div class="lg:order-1 flex flex-col lg:flex-row gap-[15px] items-start mx-[30px] md:items-center">
          <div v-for="address in addressList" class="flex lg:block max-w-[313px] text-left lg:text-center">
            <img :src="address.img" alt="#" class="mr-[20px] lg:mx-auto mb-[10px]" />
            <p class="text-[16px]">{{ address.address }}</p>
          </div>
        </div>
      </div>
      <div class="lg:order-1 mx-[20px] px-[50px] py-[52px] w-auto lg:w-[453px] border rounded-xl shadow-lg">
